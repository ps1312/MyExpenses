//
//  ExpensesLocalizationTests.swift
//  MyFinancesTests
//
...
class ExpensesLocalizationTests: XCTestCase {
    func test_localized_hasAllKeysAndValuesForSupportedLocalizations() {
        let table = "Expenses"
        let presentationBundle = Bundle(for: ExpensesViewModel.self)
